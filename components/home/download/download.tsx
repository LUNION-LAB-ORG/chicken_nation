        ...
        <div className="bg-secondary py-12 md:py-0 relative">
                <div className="hidden md:block w-full h-[60vh] md:h-[80vh] relative">
                  ...
                  <Motion variant="verticalSlideIn">
                    <div className="font-title text-white text-2xl md:text-5xl text-center md:text-start font-semibold">Pour commander appelez nous au<br />  0720353535 / 0747000034</div>
                  </Motion>
                  <Motion variant="verticalSlideIn">
