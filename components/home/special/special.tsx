      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {deals.map((deal, index) => (
            <div
              key={deal.id}
              className={`bg-[#FFF5EE] rounded-2xl p-6 shadow-lg transition-all duration-300
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <p className="text-lg font-semibold">Prix: <span className="text-primary">{deal.price}</span></p>
