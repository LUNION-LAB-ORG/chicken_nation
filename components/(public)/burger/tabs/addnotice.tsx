...
export default function AddNotice() {
  return (
    <div className="bg-primary-50 px-8 py-24 rounded-3xl">
      ...
      <p className="flex flex-col md:flex-row justify-center text-gray-400 text-center mb-6 gap-3 md:gap-4">
        Donne un score <span>★★★★★</span>
      </p>
        ...
        <form className="space-y-6">
          ...
          <div className="flex items-center justify-center text-center gap-2">
            ...
            <span className="text-gray-600 text-sm md:text-base">
              Sauvegarder mon nom et mon mail sur ce navigateur pour un prochain
              commentaire
            </span>
          </div>
