      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-3 items-center md:items-start justify-center md:justify-start  rounded-3xl p-6">
        ...
        <div className="flex flex-col text-center md:text-start items-start justify-between gap-4">
          ...
          <div className="flex text-center items-center gap-8">
            ...
            <div className="line-through text-center text-sm text-gray-400">
              6500 FCFA
            </div>
          </div>
          <div className="text-start">
            Laissez-vous tenter par notre création signature, Le Gourmet, une
            symphonie de saveurs qui éveillera vos papilles. Ce burger
            d&apos;exception commence par un pain brioché artisanal, légèrement
            toasté, aux graines de sésame dorées
          </div>
