  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-700">
                Les présentes conditions générales définissent les modalités de
                vente et de service entre Saveur Express, ci-après dénommé
                &quot;le restaurant&quot;, et ses clients.
              </p>
            </div>
            <div>
              <h3 className="font-medium mb-2">1.2 Application</h3>
              <p className="text-gray-700">
                Ces conditions s&apos;appliquent à toutes les commandes et
                services proposés par le restaurant, que ce soit sur place, à
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                ...
                <li>
                  Le restaurant se réserve le droit de refuser toute commande
                  anormale ou excessive
                </li>
                <li>
                  Les prix affichés sont en euros TTC et peuvent être modifiés
                  sans préavis
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                Le restaurant se réserve le droit de modifier sa carte et ses
                menus sans préavis en fonction de la disponibilité des produits.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                ...
                <li>
                  Les offres promotionnelles sont valables uniquement pendant
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                ...
                <li>
                  Non cumulables avec d&apos;autres promotions sauf mention
                  contraire
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                ...
                <li>
                  Le restaurant décline toute responsabilité en cas de
                  non-signalement
                </li>
              </ul>
            </div>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-3">
            6. Responsabilité et Réclamations
          </h2>
          <div className="space-y-4">
            <div>
              <h3 className="font-medium mb-2">
                6.1 Responsabilité du Restaurant
              </h3>
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                <li>
                  Le restaurant se réserve le droit de modifier ces conditions
                </li>
